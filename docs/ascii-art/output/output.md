...
available  
Go 6.13 kB  go -> 28% 2 -> 3 Optional  

## Objectives

You must follow the same [instructions](../ascii-art.md) as in the first subject while writing the result into a file.
...
The code must respect the [good practices](../../../good-practices.md).
